...
- [Source](https://github.com/embeddedos-org/{{repository}})
- [Documentation source](https://github.com/embeddedos-org/{{repository}}/blob/{{default_branch}}/{{documentation_source}})
- [Issues](https://github.com/embeddedos-org/{{repository}}/issues)
- [Discussions](https://github.com/embeddedos-org/{{repository}}/discussions)
